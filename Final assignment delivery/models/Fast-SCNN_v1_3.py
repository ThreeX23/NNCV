...
v1.3 Two bottlenecks, to discover effect of LFE()
"""
...
class Model(nn.Module):
    ...
    def __init__(self, in_channels = 3, n_classes=19):
        ...
        self.low_fe = LowFeatureExtractor(in_channels=64, out_channels=64, t=6)
        self.low_fusion = FeatureFusion(high_res_in_channels=64, low_res_in_channels=64, out_channels=64)
    ...
    def forward(self, x):
        ...
        low_level_features2 = self.low_fe(low_level_features)
        #mid_level_features = self.med_fe(low_level_features)
        high_level_features = self.feature_extractor(low_level_features)
        
        low_fused = self.low_fusion(low_level_features, low_level_features2)
        #mid_fused = self.mid_fusion(low_level_features2, mid_level_features)
        fused_features = self.fusion(low_fused, high_level_features)
