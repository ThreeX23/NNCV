...
___ SE block and refinement head.
"""
...
class Model(nn.Module):
    ...
    def __init__(self, in_channels=3, n_classes=19):
        ...
        self.se_skip2 = SEBlock(64)  # skip2 heeft 64 kanalen
        
        self.feature_extractor = GlobalFeatureExtractor(in_channels=128, out_channels=256, t=6)
        self.fusion = FeatureFusion(high_res_in_channels=128, low_res_in_channels=256, out_channels=256)
