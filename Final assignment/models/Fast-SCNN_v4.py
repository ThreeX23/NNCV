...
class GlobalFeatureExtractor(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, t):
        ...
        self.bottleneck1 = nn.Sequential(
            Bottleneck(in_channels, 128, t, stride=2),
            Bottleneck(128, 128, t, stride=1),
            Bottleneck(128, 128, t, stride=1)
        )
        self.bottleneck2 = nn.Sequential(
            Bottleneck(128, 192, t, stride=2),
            Bottleneck(192, 192, t, stride=1),
            Bottleneck(192, 192, t, stride=1)
        )
        self.bottleneck3 = nn.Sequential(
            Bottleneck(192, 256, t, stride=1),
            Bottleneck(256, 256, t, stride=1),
            Bottleneck(256, 256, t, stride=1)
        )
        self.ppm = PPM(256, out_channels)
