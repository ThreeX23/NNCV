...
In this version:
According to [1] the convolutions in the classifier phase boost performance,
therefore one DS convolution is added in the classifier.
"""
...
class Classifier(nn.Module):
    ...
    def __init__(self, in_channels, num_classes, stride):
        ...
        self.dsconv3 = DSConv(in_channels, 64, stride) ######
        self.conv = nn.Sequential(
            nn.Dropout(0.1),
